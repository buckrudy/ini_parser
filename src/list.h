...
*/
#define LIST_POISON1  ((struct list_head *) 0x00 + POISON_POINTER_DELTA)
#define LIST_POISON2  ((struct list_head *) 0x00 + POISON_POINTER_DELTA)
/*
 ...
 * This is useful for implementing queues.new
 */
